...
export type UsageAvgAggregateOutputType = {
    addressNormalizerCount: number | null;
    addressNormalizerLimit: number | null;
    routeOptimizerCount: number | null;
    routeOptimizerLimit: number | null;
};
...
export type UsageAvgAggregateInputType = {
    addressNormalizerCount?: true;
    addressNormalizerLimit?: true;
    routeOptimizerCount?: true;
    routeOptimizerLimit?: true;
};
...
export type GetUsageAggregateType<T extends UsageAggregateArgs> = {
    [P in keyof T & keyof AggregateUsage]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateUsage[P]> : Prisma.GetScalarType<T[P], AggregateUsage[P]>;
};
...
export type GetUsageGroupByPayload<T extends UsageGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<UsageGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof UsageGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], UsageGroupByOutputType[P]> : Prisma.GetScalarType<T[P], UsageGroupByOutputType[P]>;
}>>;
export type UsageWhereInput = {
    ...
    addressNormalizerCount?: Prisma.IntFilter<"Usage"> | number;
    addressNormalizerLimit?: Prisma.IntFilter<"Usage"> | number;
    routeOptimizerCount?: Prisma.IntFilter<"Usage"> | number;
    routeOptimizerLimit?: Prisma.IntFilter<"Usage"> | number;
    lastResetAt?: Prisma.DateTimeFilter<"Usage"> | Date | string;
...
export type UsageOrderByWithRelationInput = {
    ...
    addressNormalizerCount?: Prisma.SortOrder;
    addressNormalizerLimit?: Prisma.SortOrder;
    routeOptimizerCount?: Prisma.SortOrder;
    routeOptimizerLimit?: Prisma.SortOrder;
...
export type UsageScalarWhereWithAggregatesInput = {
    ...
    addressNormalizerCount?: Prisma.IntWithAggregatesFilter<"Usage"> | number;
    addressNormalizerLimit?: Prisma.IntWithAggregatesFilter<"Usage"> | number;
    routeOptimizerCount?: Prisma.IntWithAggregatesFilter<"Usage"> | number;
    routeOptimizerLimit?: Prisma.IntWithAggregatesFilter<"Usage"> | number;
    lastResetAt?: Prisma.DateTimeWithAggregatesFilter<"Usage"> | Date | string;
...
export type UsageUpdateInput = {
    ...
    addressNormalizerCount?: Prisma.IntFieldUpdateOperationsInput | number;
    addressNormalizerLimit?: Prisma.IntFieldUpdateOperationsInput | number;
    routeOptimizerCount?: Prisma.IntFieldUpdateOperationsInput | number;
    routeOptimizerLimit?: Prisma.IntFieldUpdateOperationsInput | number;
...
export type UsageSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
    id?: boolean;
    userId?: boolean;
    addressNormalizerCount?: boolean;
    addressNormalizerLimit?: boolean;
    routeOptimizerCount?: boolean;
    routeOptimizerLimit?: boolean;
    lastResetAt?: boolean;
    updatedAt?: boolean;
...
export type UsageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "addressNormalizerCount" | "addressNormalizerLimit" | "routeOptimizerCount" | "routeOptimizerLimit" | "lastResetAt" | "updatedAt", ExtArgs["result"]["usage"]>;
...
export type UsageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<UsageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface UsageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Usage'];
        meta: {
            name: 'Usage';
        };
    };
    ...
    /**
     * Find one Usage that matches the filter or throw an error with `error.code='P2026'`
     ...
     * throw `PrismaKnownClientError` with `P2026` code if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     ...
     * })
    **/
    count<T extends UsageCountArgs>(args?: Prisma.Subset<T, UsageCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], UsageCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends UsageGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, UsageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUsageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface UsageFieldRefs {
    ...
    readonly addressNormalizerCount: Prisma.FieldRef<"Usage", 'Int'>;
    readonly addressNormalizerLimit: Prisma.FieldRef<"Usage", 'Int'>;
    readonly routeOptimizerCount: Prisma.FieldRef<"Usage", 'Int'>;
    readonly routeOptimizerLimit: Prisma.FieldRef<"Usage", 'Int'>;
    readonly lastResetAt: Prisma.FieldRef<"Usage", 'DateTime'>;
